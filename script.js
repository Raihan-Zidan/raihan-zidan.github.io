...
function instantanswer() {
  ...
  } else if (searchInput.value.toLowerCase().match(/kalkulator|calculator/) && searchInput.value.split(" ").length - 2 || searchInput.value.match(/translate\s+online/) && searchInput.value.split(" ").length - 3) {
