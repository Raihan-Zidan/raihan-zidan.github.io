...
function webresult(res) {
  try {
    ...
    if (pageone) {
      document.querySelector(".result-wrapper").insertAdjacentHTML('beforeend', `<section class="footer"><ul class="list"><li><a href="/settings">Settings</a></li><li><a href="/">Privacy</a></li><li><a href="/search?q=translate">Translate</a></li></ul><ul class="list"><li>
