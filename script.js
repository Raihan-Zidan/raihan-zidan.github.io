...
function instantanswer() {
  if (searchInput.value.toLowerCase().match(/jam|waktu|time|clock/) && searchInput.value.length < 15 && searchInput.value.split(" ").length - 4) {
    ...
    document.querySelector(".main-result .result").innerHTML += `<div class="tab-result"><div class="big-title">Indonesia vs Argentina</div><div class="snippet-info">Laga tersebut akan digelar pada 19 Juni 2023.</div></div>`;
  }
}
