...
function instantanswer() {
  if (searchInput.value.toLowerCase().match(/jam|waktu|time|clock/) && searchInput.value.length < 15 && searchInput.value.split(" ").length - 4) {
    ...
    const countries={af:"Afrikaans",sq:"Albanian",am:"Amharic",ar:"Arabic",hy:"Armenian",as:"Assamese",ay:"Aymara",az:"Azerbaijani",bm:"Bambara",eu:"Basque",be:"Belarusian",bn:"Bengali",bho:"Bhojpuri",bs:"Bosnian",bg:"Bulgarian",ca:"Catalan",ceb:"Cebuano",co:"Corsican",hr:"Croatian",cs:"Czech",da:"Danish",nl:"Dutch",en:"English",eo:"Esperanto",et:"Estonian",ee:"Ewe",fil:"Filipino",fi:"Finnish",fr:"French",fy:"Frisian",ga:"Irish",gl:"Galician",de:"German",el:"Greek",gu:"Gujarati",ha:"Hausa",he:"Hebrew",hi:"Hindi",hu:"Hungarian",is:"Icelandic",ig:"Igbo",id:"Indonesian",it:"Italian",ja:"Japanese",jw:"Javanese",kn:"Kannada",kk:"Kazakh",km:"Khmer",ko:"Korean",ky:"Kyrgyz",lo:"Lao",lv:"Latvian",lt:"Lithuanian",lu:"Lushootseed",mk:"Macedonian",mg:"Malagasy",ms:"Malay",ml:"Malayalam",mt:"Maltese",mr:"Marathi",mn:"Mongolian",my:"Burmese",ne:"Nepali",no:"Norwegian",pa:"Punjabi",pl:"Polish",pt:"Portuguese",ro:"Romanian",ru:"Russian",sa:"Sanskrit",si:"Sinhala",sk:"Slovak",sl:"Slovenian",so:"Somali",es:"Spanish",su:"Sundanese",sw:"Swahili",sv:"Swedish",ta:"Tamil",te:"Telugu",th:"Thai",tr:"Turkish",uk:"Ukrainian",ur:"Urdu",uz:"Uzbek",vi:"Vietnamese",xh:"Xhosa",yo:"Yoruba",zu:"Zulu"};setTimeout(()=>{let e=document.querySelector(".trnsl"),a=e.querySelector(".from-text"),l=e.querySelector(".to-text"),n=e.querySelector(".exchange"),i=e.querySelectorAll("select"),t=e.querySelectorAll(".row i");e.querySelector("button");let r=!1;function s(){let e=document.cookie.split(";");for(let a of e){let l=a.split("=");if("settings"===l[0])return JSON.parse(l[1])||{}}return{}}function u(e){let t=a.value.trim(),s=i[0].value,u=i[1].value;if(t){l.setAttribute("placeholder","Translating..."),!l.value||e||l.value.match(a.value)?e&&(l.value="Translating...",r=!0,n.classList.add("off")):(l.value=`${l.value} ...`,n.classList.add("off"));var o="",c="https://translate.googleapis.com/translate_a/single?client=gtx&sl="+s+"&tl="+u+"&dt=t&q="+encodeURI(t);$.getJSON(c,function(e){for(var a=0;a<e[0].length;a++)o+=e[0][a][0],setTimeout(function(){l.value=o,n.classList.remove("off"),r=!1},120)})}}i.forEach((e,a)=>{for(let l in negara){let n=`<option ${0==a?"en"==l?"selected":"":"id"==l?"selected":""} value="${l}">${countries[l]}</option>`;e.insertAdjacentHTML("beforeend",n)}}),i.forEach(e=>{e.addEventListener("change",()=>{u()})}),"Indonesia"==s().lang&&(i[0].value="id",i[1].value="en"),n.addEventListener("click",()=>{var e;if(a.value&&!l.value||r)return;a.value;let n=i[0].value;a.value=l.value,i[0].value=i[1].value,i[1].value=n,u(!0)}),a.addEventListener("keyup",()=>{a.value||(l.value="")});let o,c=500;a.addEventListener("input",()=>{clearTimeout(o),a.value?o=setTimeout(u,c):a.value||l.setAttribute("placeholder","Translation"),a.value&&!l.value&&n.classList.add("off")}),t.forEach(e=>{e.addEventListener("click",({target:e})=>{if(a.value&&l.value){if(e.classList.contains("fa-copy"))"from"==e.id?navigator.clipboard.writeText(a.value):navigator.clipboard.writeText(l.value);else{let n;"from"==e.id?(n=new SpeechSynthesisUtterance(a.value)).lang=i[0].value:(n=new SpeechSynthesisUtterance(l.value)).lang=i[1].value,speechSynthesis.speak(n)}}})})},500);
  }
}
