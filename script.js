...
<span>Maps</span></div></a></div></div></div><div class="result-wrapper"><div id="hasil" class="main-result"></div></div>`;
} else {
...
function moreresult() {
  if (startIndex < 20) {
    ...
    setTimeout(()=> { document.querySelector(".show-wrapper").innerHTML = `<button class="more" onclick="moreresult();">Show more</button>`; },1000);
  } else {
