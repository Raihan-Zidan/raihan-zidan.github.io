...
if (!q || url.pathname.match(".html")) {
  ...
  const css=`.logo#main-lgx img{width:100px}.logo#main-lgx{display:flex;justify-content:center;background:#fff;padding-top:8px}@media (min-width:780px){.logo#main-lgx{position:absolute;top:6px;left:0;padding:8px 12px}}@media (max-width:940.9px){.logo#main-lgx{visibility:hidden}}.logo#main-lgx .s{position:relative}`;  
