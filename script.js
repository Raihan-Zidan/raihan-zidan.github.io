...
function webresult(res) {
  try {
    ...
    for (var i = 0; i < res.items.length; i++) {
      ...
      var isThumb = (res.items[i].snippet.length > 170 && res.items[i].pagemap.cse_thumbnail) ? `<div class="thumbnail"><img src="${res.items[i].pagemap.cse_thumbnail[0].src}"></div>` : "Tidak ada gambar ditemukan";
