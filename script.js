...
function instantanswer() {
  ...
  } else if (/kapan.*indonesia.*argentina/i.test(searchInput.value)) {
    document.querySelector(".main-result .result").innerHTML += `<div class="tab-result"><div class="title-black">Indonesia vs Argentina</div><div class="snippet">FIFA Matchday yang mempertemukan Indonesia vs Argentina direncanakan digelar di Stadion</div><div class="snippet"> Utama Gelora Bung Karno, Jakarta, pada 19 Juni 2023.</div><div class="tab-link"><a href="https://www.detik.com/jabar/sepakbola/d-6754873/link-beli-tiket-timnas-indonesia-vs-argentina-2023-siap-siap-war#:~:text=FIFA%20Matchday%20yang%20mempertemukan%20Indonesia,Jakarta%2C%20pada%2019%20Juni%202023."><div class="top"><img src="https://t0.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://www.detik.com&size=32" class="favicon"><div class="link">Detik.com</div></div><div class="title">Link Beli Tiket Timnas Indonesia Vs Argentina 2023, Siap-siap War!</div></a></div></div>`;
  }
}
...
function shwfter() {
  document.querySelector(".rcthl-wrp").insertAdjacentHTML('beforeend', `<section class="footer"><ul class="list"><li><a href="/settings">Settings</a></li><li><a href="/">Privacy</a></li><li><a href="javascript:share();">Share</a></li><li><a href="/search?q=translate">Translate</a></li></ul><div class="copyright">©Copyright 2023</div></section>`);
}
